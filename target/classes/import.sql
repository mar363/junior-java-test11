...
INSERT INTO insurancepolicy (car_id, provider, start_date, end_date, expiry_logged) VALUES (1, 'Groupama', DATE '2025-01-01', DATE '2025-09-27', FALSE );
...
UPDATE insurancepolicy SET end_date = CURRENT_DATE, expiry_logged = FALSE WHERE id = 1;